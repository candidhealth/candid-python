...
_dynamic_imports: typing.Dict[str, str] = {
    "ClaimAdjudication": ".claim_adjudication",
    "InsuranceAdjudication": ".insurance_adjudication",
    "InsuranceAdjudicationId": ".insurance_adjudication_id",
    "ServiceLineAdjudication": ".service_line_adjudication",
    "ServiceLineAdjudicationId": ".service_line_adjudication_id",
}

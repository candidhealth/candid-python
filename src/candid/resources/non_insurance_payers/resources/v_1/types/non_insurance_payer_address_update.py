...
from .....commons.types.street_address_base import StreetAddressBase
from .....commons.types.street_address_short_zip import StreetAddressShortZip


class NonInsurancePayerAddressUpdate_Remove(pydantic.BaseModel):
...
class NonInsurancePayerAddressUpdate_Set(pydantic.BaseModel):

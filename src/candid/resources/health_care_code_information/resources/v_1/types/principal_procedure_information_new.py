...
class PrincipalProcedureInformationNew(HealthCareCodeInformationNew):
    """
    This correspond to BBR, BR, and CAH code qualifier values.
    """

    principal_procedure_code_qualifier: PrincipalProcedureInformationCodeQualifier
    principal_procedure_code: IcdCode
    procedure_date: D8Date = pydantic.Field()
    """

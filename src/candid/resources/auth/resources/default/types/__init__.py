...
_dynamic_imports: typing.Dict[str, str] = {
    "AuthGetTokenResponse": ".auth_get_token_response",
    "InvalidContentTypeErrorType": ".invalid_content_type_error_type",
    "TooManyRequestsErrorType": ".too_many_requests_error_type",
}

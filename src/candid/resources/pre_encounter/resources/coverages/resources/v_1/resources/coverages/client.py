...
class AsyncCoveragesClient:
    ...
    async def create(
        ...
        async def main() -> None:
            await client.pre_encounter.coverages.v_1.coverages.create(
                request=MutableCoverage(
                    status=CoverageStatus.ACTIVE,
                    subscriber=Subscriber(
                        name=HumanName(
    ...
    async def update(
        ...
        *,
        ...
        async def main() -> None:
            await client.pre_encounter.coverages.v_1.coverages.update(
                id=uuid.UUID(
                    "d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32",
                ),
                version=1,
    ...
    async def get(self, id: CoverageId, *, request_options: typing.Optional[RequestOptions] = None) -> Coverage:
        ...
        async def main() -> None:
            await client.pre_encounter.coverages.v_1.coverages.get(
                id=uuid.UUID(
                    "d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32",
                ),
            )
    ...
    async def get_history(
        ...
        async def main() -> None:
            await client.pre_encounter.coverages.v_1.coverages.get_history(
                id=uuid.UUID(
                    "d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32",
                ),
            )
    ...
    async def get_multi(
        ...
        async def main() -> None:
            await client.pre_encounter.coverages.v_1.coverages.get_multi(
                patient_id="string",
            )
    ...
    async def scan(
        ...
        async def main() -> None:
            await client.pre_encounter.coverages.v_1.coverages.scan(
                since=datetime.datetime.fromisoformat(
                    "2024-01-15 09:30:00+00:00",
                ),
            )

...
class OrganizationServiceFacilityUpdate(pydantic.BaseModel):
    name: typing.Optional[str] = pydantic.Field(description="The name of the service facility.")
    ...
    address: typing.Optional[StreetAddressLongZip] = pydantic.Field(description="The address of the service facility.")

...
if typing.TYPE_CHECKING:
    ...
    from .errors import ReallocationWouldOverdraftError
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "AllocationOverdraftDetail": ".types",
    "AllocationRestrictionCreate": ".types",
    "AllocationRestrictionType": ".types",
    ...
    "PatientPaymentCreateSource": ".types",
    "PatientTransactionSource": ".types",
    "ReallocationWouldOverdraftError": ".errors",
    "ReallocationWouldOverdraftErrorContent": ".types",
    "RefundReason": ".types",

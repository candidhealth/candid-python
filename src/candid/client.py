...
class CandidApiClient:
    ...
    environment : CandidApiEnvironment
        The environment to use for requests from the client. from .environment import CandidApiEnvironment



        Defaults to CandidApiEnvironment.PRODUCTION
